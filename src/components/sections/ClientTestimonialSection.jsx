...
export default function ClientTestimonialSection({slides = []}) {
                        ...
                        <div className="row g-0">
                          ...
                          <div className="col-12 mxd-grid-item no-margin">
                            <div className="mxd-section-title__controls anim-uni-in-up">
                              <Link className="mxd-section-title__image-link" href="https://clutch.co/" target="_blank">
                ...
                <div className="testimonials-slider overflow-hidden anim-uni-in-up">
                  <div className="swiper-testimonials">
                          ...
                          <div className="mxd-testimonials-card bg-base-tint radius-m">
                            <div className="mxd-testimonials-card__content">
                              ...
                              <div className="mxd-testimonials-card__text">
                                <p className="anim-uni-in-up">{slide.text}</p>
                                <Link className="btn btn-anim btn-default btn-small btn-outline slide-right-up anim-uni-in-up" href={slide.projectLink}>
                            ...
                            <div className="mxd-testimonials-card__author">
                              <h5 className="mxd-testimonials-card__name anim-uni-in-up">{slide.name}</h5>
                              <p className="mxd-testimonials-card__position t-small anim-uni-in-up">
                                {slide.role} in <Link href="#">{slide.company}</Link>
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="swiper-button-prev mxd-slider-btn mxd-slider-btn-round-prev animate-card-2">
                      <a className="btn btn-round btn-round-small btn-outline slide-left anim-no-delay">
                        <i className="ph ph-arrow-left" />
                      </a>
                    </div>

                    <div className="swiper-button-next mxd-slider-btn mxd-slider-btn-round-next animate-card-2">
                      <a className="btn btn-round btn-round-small btn-outline slide-right anim-no-delay">
